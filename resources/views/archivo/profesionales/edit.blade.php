...
@section ('contenido')
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Editar Porfesional: {{ $profesional->apeynom_profesional}}</h3>
			@if (count($errors)>0)
	...
	{!!Form::model($profesional,['url'=>['archivo/profesionales',$profesional->id_profesional],'method'=>'PATCH'])!!}
    {{Form::token()}}
        ...
        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
            <div class="form-group">
                <label for="matricula_profesional">Matrícula</label>
                    ...
                    value="{{$profesional->matricula_profesional}}" class="form-control" 
            ...
            <div class="form-group">
              <label for="apeynom_profesional">Apellido y Nombres</label>
                  <input type="text" name="apeynom_profesional" maxlength="40" required 
                    value="{{$profesional->apeynom_profesional}}" class="form-control" 
        ...
        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
                <label for="especialidad_profesional">Especialidad</label>
                    ...
                    value="{{$profesional->especialidad_profesional}}" class="form-control" 
        ...
        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
            <div class="form-group">
                <label for="dni_profesional">Documento</label>
                    ...
                    value="{{$profesional->dni_profesional}}" class="form-control" 
        ...
        <div class="col-lg-5 col-sm-5 col-md-5 col-xs-12">
            <div class="form-group">
                <label for="domicilio_profesional">Domicilio</label>
                    ...
                    value="{{$profesional->domicilio_profesional}}" class="form-control" 
        ...
        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
                <label for="localidad_profesional">Localidad</label>
                    ...
                    value="{{$profesional->localidad_profesional}}" class="form-control" 
        ...
        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
            <div class="form-group">
                <label for="fechanac_profesional">Fecha de Naciemiento</label>
                    ...
                    value="{{$profesional->fechanac_profesional}}" max="<?php echo date("Y-m-d",strtotime(date("Y-m-d"))); ?>" class="form-control">
            </div>
        </div>
        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
            <div class="form-group">
                <label for="edad_profesional">Edad</label>
                    ...
                    value="{{$profesional->edad_profesional}}" class="form-control">
            </div>
        </div>
        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
            <div class="form-group">
                <label for="telefono_profesional">Teléfono</label>
                    ...
                    value="{{$profesional->telefono_profesional}}" class="form-control"
        ...
        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
                <label for="email_profesional">Email</label>
                    ...
                    value="{{$profesional->email_profesional}}" class="form-control" placeholder="Email...">
            </div>
        </div>
    </div>
    <div class="row justify-content-center">
