...
@section ('contenido')
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h3>Editar Día Asignado al Acompañante</h3>
			@if (count($errors)>0)
	...
	{!!Form::model($acompanante,['url'=>['archivo/pacienteacompanantes',$acompanante->id_pacienteacompanante],'method'=>'PATCH'])!!}
    {{Form::token()}}
        ...
        <div class="col-lg-9 col-sm-9 col-md-9 col-xs-12">
            <div class="form-group">
                ...
                @foreach ($pacientes as $paci)
                    @if($paci->estado_paciente=='1' && $paci->id_paciente==$acompanante->id_paciente)
        ...
        <div class="col-lg-9 col-sm-9 col-md-9 col-xs-12">
            <div class="form-group">
                ...
                @foreach ($acompanantes as $acomp)
                    @if($acomp->estado_acompanante=='1' && $acomp->id_acompanante==$acompanante->id_acompanante)
                        <option value="{{$acomp->id_acompanante}}" selected>{{$acomp->apeynom_acompanante}}</option>
                    @else
        ...
        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
            <div class="form-group">
                <label for="fecha_pacienteacompanante">Seleccione Día</label>
                    ...
                    value="{{$acompanante->fecha_pacienteacompanante}}" min="<?php echo date("Y-m-d",strtotime(date("Y-m-d"))); ?>" class="form-control">
            </div>
        </div>
        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
            <div class="form-group">
                <label for="horainicio_pacienteacompanante">Hora Inicio</label>
                    ...
                    value="{{$acompanante->horainicio_pacienteacompanante}}" class="form-control">
            </div>
        </div>
        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
            <div class="form-group">
                <label for="horafin_pacienteacompanante">Hora Fin</label>
                    ...
                    value="{{$acompanante->horafin_pacienteacompanante}}" class="form-control">
            </div>
        </div>
            ...
            <div class="form-group">
                <label>Selecione Estado</label>
                    <select name="estado_pacienteacompanante" class="form-control" required>
                      @if ($acompanante->estado_pacienteacompanante=='Activo')
                        <option value="Activo" selected>ACTIVO</option>
                        <option value="Realizado">REALIZADO</option>
                        <option value="Cancelado">CANCELADO</option>
                      @elseif ($acompanante->estado_pacienteacompanante=='Realizado')
        ...
        <div class="col-lg-9 col-sm-9 col-md-9 col-xs-12">
            <div class="form-group">
                <label for="obs_pacienteacompanante">Observaciones</label>
                    ...
                    value="{{$acompanante->obs_pacienteacompanante}}" class="form-control" placeholder="Observaciones...">
            </div>
        </div>
    </div>
    <div class="row justify-content-center">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                <div class="form-group"> 
                    ...
                    <textarea class="form-control" name="informe_pacienteacompanante" rows="3"  
                        maxlength="1000" align="text-justify">{{$acompanante->informe_pacienteacompanante}}
                    </textarea>
                </div>
            </div>
    </div>
