...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Nuevo Acompañante Terapéutico</h3>
			@if (count($errors)>0)
	...
	{!!Form::open(array('url'=>'archivo/acompanantes','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}
        ...
        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
                <label for="apeynom_acompanante">Apellido y Nombres</label>
                    ...
                    value="{{old('apeynom_acompanante')}}" class="form-control" placeholder="Apellido y Nombres...">
            </div>
        </div>
        ...
        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
            <div class="form-group">
                <label for="edad_acompanante">Edad</label>
                    ...
                    value="{{old('edad_acompanante')}}" class="form-control">
            </div>
        </div>
        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
            <div class="form-group">
                <label for="telefono_acompanante">Teléfono</label>
                    ...
                    value="{{old('telefono_acompanante')}}" class="form-control" placeholder="Teléfono...">
            </div>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                <label for="formacion_acompanante">Formación</label>
                    ...
                    value="{{old('formacion_acompanante')}}" class="form-control" placeholder="Formación...">
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                <label for="disponibilidad_acompanante">Disponibilidad</label>
                    ...
                    value="{{old('disponibilidad_acompanante')}}" class="form-control" placeholder="Disponibilidad...">
            </div>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
            <div class="form-group">
                <label for="obs_acompanante">Observaciones</label>
                    ...
                    value="{{old('obs_acompanante')}}" class="form-control" placeholder="Observaciones...">
            </div>
        </div>
    </div>
    <div class="row justify-content-center">
