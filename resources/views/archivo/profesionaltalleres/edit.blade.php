...
@section ('contenido')
	...
	{!!Form::model($taller,['url'=>['archivo/profesionaltalleres',$taller->id_profesionaltaller],'method'=>'PATCH'])!!}
    {{Form::token()}}

    <div class="row justify-content-center">
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <div class="form-group">
                <label for="estado_profesionaltaller">Seleccione una opción</label>
                    <select name="estado_profesionaltaller" class="form-control" required>
